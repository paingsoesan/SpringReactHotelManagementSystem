...
import com.example.springreacthotelmanagement.service.interfac.IBookingService;
...
public class BookingService implements IBookingService {
    ...
    public Response cancleBooking(Long bookingId) {
        ...
        try {
            Booking bookingList = bookingRepository.findById(bookingId).orElseThrow(() -> new OurException("Booking Does Not Exists"));
